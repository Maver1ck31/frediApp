package com.limyrac.ppe.bouetardhenryleclerctoutain.fredi;
...
public class register extends AppCompatActivity {
    ...
    private class PostRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                final TextView outputView = (TextView)findViewById(R.id.userOUT);
            ...
            public void run() {
                ...
                {
                    Toast.makeText(context, "error : " + finalMessage, Toast.LENGTH_SHORT);
                ...
                {
                    Toast.makeText(context, "OK : " + finalMessage, Toast.LENGTH_SHORT);
                }
                else
                {
                    Toast.makeText(context, "error : " + finalMessage, Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tuserOUT = (TextView)findViewById(R.id.userOUT);
    }
